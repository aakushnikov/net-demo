...
namespace Crawler.Contracts.Impl.Proxies
{
	public class HtmlParserService : IHtmlParserService
	{
		...
		private static HttpWebRequest GEtHttpWebRequest(string url, string postData, List<Cookie> cookies, ProxyItem proxy)
		{
			...
			request.UserAgent =
				"Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.95 YaBrowser/17.1.0.2034 Safari/537.36";
